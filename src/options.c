...
static struct poptOption popt_options[] =
{
    {   "input", 'i', POPT_ARG_STRING,
        NULL, 0,
        "Input file, omit for stdin", "Filename or - for stdin" },
    {   "output", 'o', POPT_ARG_STRING,
        NULL, 0,
        "Output file, omit for stdout", "Filename or - for stdout" },
    {   "xyz", 'x', POPT_ARG_STRING,
        NULL, 0,
        "Mapping of XYZ to output colour channels",
        "eg 'rgb' (default), 'agb'" },
    {   "xyz", 'x', POPT_ARG_STRING,
        NULL, 0,
        "Mapping of XYZ to output colour channels",
    ...
    {   "scale", 's', POPT_ARG_DOUBLE,
        NULL, 0,
        "Scale of heightmap (implies --normalise)",
